...
export function NoteCard({ note }: NoteCardProps) {
  ...
  return (
    <div className="group relative flex flex-col gap-2 rounded-md border-[0.5px] border-border bg-background p-4 transition-colors duration-[120ms] hover:border-accent-muted">
